...
from mlflow.utils.autologging_utils import logging_and_warnings as mlflow_logging
from tqdm.contrib.logging import logging_redirect_tqdm

from ..util.logging_vars import bound_logvars
...
class InitWrapper[**P, R]:
    ...
    def __init__(
        ...
        **wrapper_kwargs,
        ...
        mlflow_logging.ORIGINAL_SHOWWARNING = warnings.showwarning  # Reset MLflow
    ...
    def __call__(self, target: Callable[P, R]) -> Callable[P, R]:
        ...
        target_fullname = f"{target_module}.{target_name}".lstrip(".")

        @bound_logvars(task=target_fullname)
